...
public class DeviceUtils {
    ...
    public static String getIMEI(Context ctx) {
        ...
        return ((TelephonyManager) Objects.requireNonNull(ctx.getSystemService(Context.TELEPHONY_SERVICE))).getDeviceId();
    }
    ...
    public static String getIMSI(Context ctx) {
        ...
        return Objects.requireNonNull(tm).getSubscriberId() != null ? tm.getSubscriberId() : null;
    }
    ...
    public static String getWifiMacAddr(Context ctx) {
        ...
        try {
            ...
            macAddr = Objects.requireNonNull(wifi).getConnectionInfo().getMacAddress();
            if (macAddr == null) {
                macAddr = "";
            }
        } catch (Exception e) {
    ...
    public static String getIP(Context ctx) {
        ...
        return Objects.requireNonNull(wifiManager).isWifiEnabled() ? getWifiIP(wifiManager) : getGPRSIP();
    }
    ...
    public static String getSIMSerial(Context ctx) {
        ...
        return Objects.requireNonNull(tm).getSimSerialNumber();
    }

    public static String getMNC(Context ctx) {
        String providersName = "";
        TelephonyManager telephonyManager = (TelephonyManager) ctx.getSystemService(Context.TELEPHONY_SERVICE);
        if (Objects.requireNonNull(telephonyManager).getSimState() == TelephonyManager.SIM_STATE_READY) {
    ...
    public static String getCarrier(Context ctx) {
        TelephonyManager tm = (TelephonyManager) ctx.getSystemService(Context.TELEPHONY_SERVICE);
        return Objects.requireNonNull(tm).getNetworkOperatorName().toLowerCase(Locale.getDefault());
    }
    ...
    public static String getScreenDisplayID(Context ctx) {
        ...
        return String.valueOf(Objects.requireNonNull(wm).getDefaultDisplay().getDisplayId());
    }
    ...
    public static String getCountry(Context ctx) {
        ...
        return Objects.requireNonNull(tm).getSimState() == TelephonyManager.SIM_STATE_READY ? tm.getSimCountryIso().toLowerCase(Locale.getDefault()) : locale.getCountry().toLowerCase(locale);
    }
